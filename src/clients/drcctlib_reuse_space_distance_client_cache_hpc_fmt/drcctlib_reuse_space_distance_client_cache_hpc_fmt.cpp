...
#define DRCCTLIB_PRINTF(format, args...) \
    DRCCTLIB_PRINTF_TEMPLATE("reuse_space_distance_client_cache_hpc_fmt", format, ##args)
#define DRCCTLIB_EXIT_PROCESS(format, args...)                                          \
    DRCCTLIB_CLIENT_EXIT_PROCESS_TEMPLATE("reuse_space_distance_client_cache_hpc_fmt", format, \
                                          ##args)
