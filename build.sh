...
echo "-----Test 3---------" && ${RUN_DIRECTORY}/drrun -t drcctlib_instr_statistics -- ${APPSAMPLES}/build/sample_cct > ${BUILD_LOG_PATH}/build_test.drcctlib_instr_statistics.sample_cct.log 2>&1 && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo "-----Test 4---------" && ${RUN_DIRECTORY}/drrun -t drcctlib_instr_statistics -- ${APPSAMPLES}/build/sample_multithread > ${BUILD_LOG_PATH}/build_test.drcctlib_instr_statistics.sample_multithread.log 2>&1 && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo "-----Test 5---------" && ${RUN_DIRECTORY}/drrun -t drcctlib_reuse_distance -- ${APPSAMPLES}/build/sample_reuse > ${BUILD_LOG_PATH}/build_test.drcctlib_reuse_distance.sample_reuse.log 2>&1 && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo "-----Test 6---------" && ${RUN_DIRECTORY}/drrun -t drcctlib_all_instr_cct_hpc_fmt -- ${APPSAMPLES}/build/sample_cct > ${BUILD_LOG_PATH}/build_test.drcctlib_all_instr_cct_hpc_fmt.sample_reuse.log 2>&1 && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo "*************************************************"
