...
# run cmake
cmake -DDEBUG=ON ${DYNAMORIO_ROOT_PATH} >${CMAKE_LOG_FILE} 2>&1
...
echo -e "\033[32m-----Testing Dynamorio---------\033[0m" && ${RUN_DIRECTORY}/drrun -debug -- echo hi > /dev/null && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo -e "\033[32m----------Test 1---------\033[0m" && ${RUN_DIRECTORY}/drrun -debug -unsafe_build_ldstex -t drcctlib_all_instr_cct -- ${APP1_FULL_PATH} > /dev/null && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo -e "\033[32m----------Test 2---------\033[0m" && ${RUN_DIRECTORY}/drrun -debug -unsafe_build_ldstex -t drcctlib_all_instr_cct -- ${APP2_FULL_PATH} > /dev/null && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo -e "\033[32m----------Test 3---------\033[0m" && ${RUN_DIRECTORY}/drrun -debug -unsafe_build_ldstex -t drcctlib_instr_statistics -- ${APP1_FULL_PATH} > /dev/null && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo -e "\033[32m----------Test 4---------\033[0m" && ${RUN_DIRECTORY}/drrun -debug -unsafe_build_ldstex -t drcctlib_instr_statistics -- ${APP2_FULL_PATH} > /dev/null && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
echo -e "\033[32m----------Test 5---------\033[0m" && ${RUN_DIRECTORY}/drrun -debug -unsafe_build_ldstex -t drcctlib_reuse_distance -- ${APP3_FULL_PATH} > /dev/null && echo -e "\033[32m----------PASSED---------\033[0m" || (echo -e "\033[31m----------FAILED---------\033[0m"; exit -1)
